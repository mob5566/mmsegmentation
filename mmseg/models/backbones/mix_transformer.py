...
class MixVisionTransformerDA(BaseModule):
...
@BACKBONES.register_module()
class mit_b0(MixVisionTransformerDA):
...
@BACKBONES.register_module()
class mit_b1(MixVisionTransformerDA):
...
@BACKBONES.register_module()
class mit_b2(MixVisionTransformerDA):
...
@BACKBONES.register_module()
class mit_b3(MixVisionTransformerDA):
...
@BACKBONES.register_module()
class mit_b4(MixVisionTransformerDA):
...
@BACKBONES.register_module()
class mit_b5(MixVisionTransformerDA):
